    ...
    <div className='bg-sky-100 w-full'>
      <div className='flex flex-col mx-auto min-h-screen max-w-[500px] items-center py-10 '>
        ...
        <div className='w-full flex flex-col gap-5 px-10'>
          <a href='https://github.com/vf-jara' target="_blank" className='font-medium text-xl'>
          ...
          <a href='https://www.linkedin.com/in/vfjara21/' target="_blank" className='font-medium text-xl'>
          ...
          <a href='mailto:viniciusfjara@gmail.com' target="_blank" className='font-medium text-xl'>
